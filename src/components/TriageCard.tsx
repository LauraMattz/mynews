        ...
        <CardContent className="p-3 sm:p-4">
          <div className="flex items-start gap-2 sm:gap-3">
            ...
            <div className="flex-1 min-w-0 space-y-1.5">
              ...
              <p className="text-[11px] sm:hidden select-none flex items-center justify-center gap-3 pt-1">
                <span className="text-destructive font-bold tracking-wide">← DESCARTAR</span>
                <span className="text-muted-foreground/30 text-lg">·</span>
                <span className="text-emerald-500 font-bold tracking-wide">APROVAR →</span>
              </p>
            </div>
